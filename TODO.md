...
2. Конфиг панель.
  ...
  - CONTENT_HEIGHT сделать больше. [Выполнено]
3. Если одно из колец закрывает кнопку открытия конфига(справа) - конфиг нельзя открыть. [Выполнено]
4. Заменить ТУМБЛЕРЫ на чекбоксы, а то тут один чупапкинс не доволен. [Выполнено]
### 2. Добавление заглушек
- В интерфейсе добавить:
  - Сохранить параметры. [Выполнено]
- Эти элементы должны быть **видимы**, но **не функциональны**. [Выполнено]
